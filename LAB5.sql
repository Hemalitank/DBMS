 ...
 SRUDID INT,FIRSTNAME VARCHAR(50),LASTNAME VARCHAR(50),WEBSITE VARCHAR(50),CITY VARCHAR(50),ADDRESS VARCHAR(50)
 )
 --INSERT DATA
...
SELECT FIRSTNAME,LASTNAME FROM STUDENT WHERE CITY LIKE'%A'
...
--4. Display all the names those are either four or five charactersSELECT FIRSTNAME FROM STUDENT WHERE FIRSTNAME LIKE'[____,_____]'